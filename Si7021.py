...
class Si7021(object):
    ...
    def _get_device_info(self):
        ##Get the serial number and the sensor identifier. The identifieris part of the bytes returned for the serial number.
    ...
    def _get_device_identifier(self, identifier_byte):
        ##Convert the identifier byte to a device identifier. Values are based on the information from page 24 of the datasheet.
    ...
    def _verify_checksum(self, data):
        ##Verify the checksum using the polynomial from page 19 of the datasheet.
